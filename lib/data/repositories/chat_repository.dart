...
class ChatRepository {
  Future<DataOutput<ChatUser>> fetchBuyerChatList(int page) async {
    Map<String, dynamic> queryParameters = {Api.type: "buyer", Api.page: page};

    // Add country parameter
    final country = AppSession.currentLocation?.country?.canonical;
    if (country != null) {
      queryParameters[Api.country] = country;
    }
  ...
  Future<DataOutput<ChatUser>> fetchSellerChatList(int page) async {
    Map<String, dynamic> queryParameters = {Api.page: page, Api.type: "seller"};
