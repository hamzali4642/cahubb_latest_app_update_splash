...
class FetchSubCategoriesCubit extends Cubit<FetchSubCategoriesState> {
  ...
  /// Validates if user can post ad in the selected category
  /// Returns the category data with subcategories if valid, throws error if not
  Future<DataOutput<CategoryModel>> validateCategoryForListing({
    required int categoryId,
  }) async {
    try {
