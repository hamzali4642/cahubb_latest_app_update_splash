...
class _SliderWidgetState extends State<SliderWidget>
      ...
      child: BlocBuilder<SliderCubit, SliderState>(
        builder: (context, SliderState state) {
          ...
          if (state is SliderFetchSuccess) {
            ...
            bannersLength = state.sliders.length; // Update bannersLength
            return SizedBox(
              height: 170,
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  HomeSlider homeSlider = state.sliders[index];
                  return InkWell(
                    onTap: () async {
  ...
  Future<void> sliderTap(HomeSlider homeSlider) async {
    ...
    } else if (homeSlider.modelId != null) {
      Navigator.pushNamed(
        context,
        Routes.adDetailsScreen,
        arguments: {"item_id": homeSlider.modelId},
      );
    }
  }
}
