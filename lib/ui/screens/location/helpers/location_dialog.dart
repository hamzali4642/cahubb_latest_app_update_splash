...
class LocationDialog {
  static Future<void> show(
    ...
    ///Todo(I): Refactor this to something more stable
    bool didTapButtonInPermissionDialog = false;

    final newOnCancel = () {
      onCancel?.call();
      didTapButtonInPermissionDialog = true;
    };
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (!didTapButtonInPermissionDialog) {
        onCancel?.call();
      }
