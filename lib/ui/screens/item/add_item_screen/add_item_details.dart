...
class _AddItemDetailsState extends CloudState<AddItemDetails>
  ...
  void initState() {
    ...
    if (widget.isEdit ?? false) {
      ...
      // Set currency from item if available (for edit mode)
      // Note: This assumes the item model will have currency_id in future
      // For now, we'll use the default selected currency
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  CustomText(
                    selectedCurrency?.symbol ?? Constant.currencySymbol,
                    fontSize: context.font.large,
                    color: context.color.textDefaultColor,
                    fontWeight: FontWeight.bold,
                  ),
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    title: CustomText('${currency.code} (${currency.symbol})'),
                    trailing: isSelected
