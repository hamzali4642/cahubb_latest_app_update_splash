...
class CarInspectionBookingScreen extends StatefulWidget {
  ...
  @override
  State<CarInspectionBookingScreen> createState() =>
      _CarInspectionBookingScreenState();
}
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomText(
                  currentStepIndex == 0
                      ? 'Share your basic details to start the inspection request.'
                      : 'Choose the visit location, date, and preferred time slot.',
