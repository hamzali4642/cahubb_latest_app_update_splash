  ...
  Widget adsWidget(
    ...
    return Column(
      ...
      children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (package.listingDuration != null)
                    CustomText(
                      '${'listingValidity'.translate(context)}: ${package.listingDuration}\t${"days".translate(context)}',
        ...
        else if (package.description != null && package.description!.isNotEmpty)
