...
class _ChatScreenState extends State<ChatScreen>
  ...
  void initState() {
    ...
    currentlyChattingWith = widget.userId;
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
                  ...
                  child: Row(
                    children: [
                      FittedBox(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            final itemId = int.tryParse(widget.itemId);
                            ...
                            children: [
                              ...
                              if (widget.itemPrice != null)
                                Padding(
                                  ...
                                  child: CustomText(
                                    widget.itemPrice!,
                                    // Use formatted price from API if available
                                    color: context.color.textDefaultColor,
                                    fontSize: context.font.large,
          ...
          title: FittedBox(
            ...
            child: Row(
              children: [
                ProfileAvatar(src: widget.profilePicture),
