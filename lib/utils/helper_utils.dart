...
class HelperUtils {
  ...
  static String shareUrl(String type, String value) {
    return "${AppConfig.shareDomain}/$type/$value?share=true";
  }
  ...
  static void maybeSubscribeToTopics() async {
    final isSubscribed = await HiveUtils.getHasSubscribedToTopics();
    if (!isSubscribed) {
      await FirebaseMessaging.instance.subscribeToTopic(
        Constant.generalNotificationTopic,
      );
      await HiveUtils.setHasSubscribedToTopics(true);
    }
  }

  static void unSubscribeToTopics() async {
    await FirebaseMessaging.instance.unsubscribeFromTopic(
      Constant.generalNotificationTopic,
    );
    await HiveUtils.setHasSubscribedToTopics(false);
  }
