class AppIcons {
  ...
  static String refundPolicy = _svgPath('refund_policy');
  ...
  static String somethingWentWrong = _svgPath(
    "Illustrators/something_went_wrong",
  );
  ...
  static String no_data_found = _svgPath(
    "Illustrators/no_data_found_illustrator",
  );
  ...
  static String locationDenied = _svgPath('Illustrators/location_denied');
  ...
  static String userVerificationIcon = _svgPath(
    "Illustrators/user_verification",
  );
